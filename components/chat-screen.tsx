    ...
    <div className="py-2 h-[500px] flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto mb-4 space-y-4 pr-1">
        {messages.map((message) => (
          <ChatMessage key={message.id} message={message} translationEnabled={translationSettings.enabled} />
        ))}
      ...
      <div className="border-t border-border/40 pt-4">
        ...
        <div className="flex justify-between mt-2 text-xs">
          <div className="flex items-center gap-2">
            <TranslationToggle enabled={translationSettings.enabled} onToggle={toggleTranslation} />
            <TranslationSettingsDialog settings={translationSettings} onUpdateSettings={updateSettings} />
          </div>
          <TranslationStatus active={isTranslating || isSending} />
        </div>
      </div>
    </div>
  )
...
function ChatMessage({ message, translationEnabled }) {
